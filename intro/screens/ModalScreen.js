import { Text, StyleSheet, View, TouchableOpacity, Switch, TextInput, Alert, Platform } from 'react-native'
...
export default function ModalScreen() {
  ...
  const botonGuardar = () => {
    ...
    if (Platform.OS === 'web') {
      alert(`Éxito: Prueba Realizada, Nombre: ${descripcion} y Número favorito: ${monto}`)
    } else {
      Alert.alert('Éxito', `Prueba Realizada, Nombre: ${descripcion} y Número favorito: ${monto}`)
    }
