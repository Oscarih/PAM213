public class inicioPAM {
    ...
    public String PorsentajesporParcial() {
        return "
        Porsentajes por Parcial:
        --------------------------------------------------------------------------------------------------------------------------------------
                        EVIDENCIA DE CONOCIMIENTO       EVIDENCIA DE DESEMPEÑO      EVIDENCIA DE PRODUCTO       PROYECTO INTEGRADOR
        --------------------------------------------------------------------------------------------------------------------------------------
        * 1er Parcial:             40%                            20%                         30%                       10%
        --------------------------------------------------------------------------------------------------------------------------------------
        * 2do Parcial:             40%                            20%                         20%                       20%
        --------------------------------------------------------------------------------------------------------------------------------------
        * 3er Parcial:             20%                            10%                         40%                       30%
